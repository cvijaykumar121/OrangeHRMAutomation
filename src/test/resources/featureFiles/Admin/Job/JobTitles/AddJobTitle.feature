...
#    Adding job title to the employee's profile
    ...
    Examples:
      ...
      | Ajay       | Kumar       | Chadayan  | Software Engineer Level 1 | Develops software | Note details | 1001        |
...
#    Checking the Job Title displayed in employee's profile by logging in with employee's credentials
    ...
    Examples:
      ...
      | Software Engineer Level 2 | Develops software | Note details | Vijay      | Kumar       | Chadayan  | 1002        | vijay123 | Password@1234 | Password@1234    |
