Feature: Manage Leave Approvals Notifications in Email Subscriptions
  As an admin, I want to manage subscribers for Leave Approvals notifications
  So that employees and relevant stakeholders receive timely updates about leave approvals
  ...
  Background:
    ...
    When I select the "Leave Approvals" notification type

  Scenario Outline: Add a New Subscriber to Leave Approvals Notifications
...
#    Given I am on the Add Subscriber form in the Leave Applications notifications section
    ...
    Then "charles@gmail.com" should still be subscribed from Leave Approvals notifications
